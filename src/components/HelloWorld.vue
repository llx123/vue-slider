<template>
  <div class="content">
    <div class="Box_con clearfix">
      ...
      <div class="bigPic">
        <ul ref="tUl">
          <li class="cur" v-for="(i, index) in bigPicList.slice(0,3)" :key="index">
            <img :src="i" alt="">
          </li>
        </ul>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      bigPicList: [img1,img2,img3,img4,img5],
      ulWidth: 0,
      tw: 0,
      htmlWidth: 0,
      canClick: true
...
.Box_con .btnl:hover {}
.Box_con .btnr:hover {}
.Box_con .conbox {position: relative;overflow: hidden; height: 200px;}
...
.bigPic {position: relative;overflow: hidden;height: auto;}
.bigPic ul {position: relative;list-style: none;}
.bigPic ul li {float: left;width: 718px;height: auto;margin-left: 20px;overflow: hidden;word-break: break-all;}
